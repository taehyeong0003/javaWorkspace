...
public class B_Logical {
	 ...
	 * OR	|| : a || b -> a와 b가 모두 거짓인 경우에만 false반환
	 * 						둘중 하나라도 true값이 들어간 경우 true 반환
	 */
	public void method1() {
		Scanner sc = new Scanner(System.in);
		
		System.out.println("숫자를 아무거나 입력해 주세요 : ");
		int num = sc.nextInt();
	...
	public void method2() {
		...
		System.out.println("num의 값은 1이상 100이하입니까? "+result);
	}
	...
	public void method4() {
		...
		// 뒤 쪽 조건들은 "무조건" false이기 떄문에 뒤 쪽 조건식은 실행되지도 않는다.
		...
		int num2 = 10;
		// or연산자는 A || B중 A가 참일 경우 뒤 쪽 조건식은 검사하지 않고 참을 반환
