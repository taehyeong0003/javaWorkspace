...
public class B_Switch {
	 ...
	 * 하지만, switch는 확실한 하나의 값만 기술(동등비교만 가능)
	 * [표현법]
	 * switch(동등비교할 조건식, 변수) {
	 ...
	 * case 값n :
	 * ...
	 * default : 위의 값들 중 일치하는 값이 없는 경우 실행할 코드 기술
	 * 			 break;
	 * }
	 * 
	 * switch 장점 -> case를 통해 내가 실행하기를 원하는 코드로 즉시 이동하므로
	...
	public void method2() {
		...
		System.out.print("KH 과일과게");
		System.out.println("구매할 과일(사과, 망고, 바나나)");
