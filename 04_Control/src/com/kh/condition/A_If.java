...
public class A_If {
	 ...
	 * 프로그램의 실행 순서
	 * 
	 * 선택적으로 특정 라인을 실행시키고자 할 때 => 제어문
	 * 반복적으로 실행해야 하는 코드 => 반복문
	 * 반복문 내부 흐름을 제어하는 경우 => 분기문
	 * 
	 * if(조건문)
	 * 조건문 : 조건식을 사용하여 true/false값이 나오도록 설정하는 식
	 */
	...
	public void method3() {
		 ...
		 * if ~ elsee if문
		 * 
		 * 같은 비교대상 여러개의 조건을 제시해야 하는 경우 사용
		 * [표현법]
	...
	public void method6() {
		...
		// 문자열 동등비교를 위한 메서드
		// 문자열.equals(비교문자열)
		if(name.equals("안태형")) {	//"안태형".equals(name)도 사용 가능
