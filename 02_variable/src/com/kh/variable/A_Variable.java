...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("==== 변수 x ===="); // sysout 치고 cntl+space로 자동완성
		
		System.out.println("시급 : 8500");
		System.out.println("근무시간 : 6");
		System.out.println("근무일수 : 5");
		
		System.out.println("안태형 : "+ 8500 * 6 * 5 + "원");
		...
		System.out.println("안태형 : "+ pay * time * day + "원");
		/* 
		 * 변수를 사용하는 이유
		 * 1. 가독성 확보
		 * 2. 재사용성 증대
	...
	public void declareVariable() {
		 ...
		 * 자료의 변수형;
		 * 
		 * 자료형 : 어떤 값을 담아낼지, 어떤 크기의 값을 담아낼지에 따라 다르게 지정해야 한다
		 * 변수명 : 변수의 이름을 저장하는 부분
		 * 
		 * 변수명 명명규칙
		...
		//2-2. 실수형
		float fNum;		// 4byte 소숫점 7자리까지 표현
		double dNum;	// 8byte 소숫점 15자리까지 표현 ==> 정수 대표자료형
		
		// 3. 문자형
		char ch;	// 2byte
		
		// 4. 문자열(참조 자료형) => 기본 자료형에 포함됮 않음
		String str;
		...
		// 실수형 리터럴값을 float에 저장시 반드시 f를 붙여줘야 함
		fNum = 4.0f;
		dNum = 8.0;
	...
	public void constant() {
		...
		// 상수값을 저장하는 변수는 무조건 "대문자"를 활용한다 띄어쓰기는 _로
		final int AGE = 21;
